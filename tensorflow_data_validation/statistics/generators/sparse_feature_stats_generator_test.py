...
class SparseFeatureStatsGeneratorTest(test_util.CombinerStatsGeneratorTest):
    def test_sparse_feature_generator_valid_input(self):
        ...
        expected_result = {
            types.FeaturePath(["sparse_feature"]): text_format.Parse(
                """
                path {
                  step: 'sparse_feature'
                }
        ...
        generator = sparse_feature_stats_generator.SparseFeatureStatsGenerator(schema)
        ...
        batches = [
            pa.RecordBatch.from_arrays(
                [
                    ...
                    pa.array(
                        [[2], [2], [2, 4, 6, 7, 9], [2, 4, 6, 7, 9], [2, 4, 6, 7, 9]]
                    ),
                ],
                ["value_feature", "index_feature1", "index_feature2"],
            ),
    ...
    def test_sparse_feature_generator_with_struct_leaves(self):
        ...
        expected_result = {
            types.FeaturePath(["parent", "sparse_feature"]): text_format.Parse(
                """
                path {
                  step: 'parent'
                  step: 'sparse_feature'
        ...
        batches = [
            pa.RecordBatch.from_arrays(
                [
                    ...
                    pa.array(
                        [[2, 4], [2, 4], [2, 4, 6], [2, 4, 6], [2, 4, 6], None, None]
                    ),
                    pa.array([None, None, None, None, None, ["a", "b"], ["a", "b"]]),
                    pa.array([None, None, None, None, None, [2, 4], [2, 4]]),
                    pa.array(
                        [None, None, None, None, None, None, None], type=pa.null()
                    ),
                ],
                [
                    "value_feature",
    ...
    def test_sparse_feature_generator_multiple_sparse_features(self):
        batches = [
            ...
            pa.RecordBatch.from_arrays(
                ...
                ["other_value_feature", "other_index_feature1", "other_index_feature2"],
            ),
        ]
        schema = text_format.Parse(
            """
        ...
        expected_result = {
            ...
            types.FeaturePath(["other_sparse_feature"]): text_format.Parse(
                """
                path {
