...
_TEST_CASES = [
        ...
        expected_result=[
            pa.RecordBatch.from_arrays(
                [
                    ...
                    pa.array(
                        [[b"hello"], [b"world"]], pa.large_list(pa.large_binary())
                    ),
                ],
    ...
    dict(
        ...
        input_lines=["1,שקרכלשהו,22.34,text field"],
        column_names=["int_feature", "unicode_feature", "float_feature", "str_feature"],
        expected_result=[
            pa.RecordBatch.from_arrays(
                [
                    pa.array([[1]], pa.large_list(pa.int64())),
                    pa.array([[22.34]], pa.large_list(pa.float32())),
                    pa.array([["שקרכלשהו".encode()]], pa.large_list(pa.large_binary())),
    ...
    dict(
        ...
        expected_result=[
            pa.RecordBatch.from_arrays(
                [
                    pa.array(
                        [[b"34"], [str(sys.maxsize + 1).encode("utf-8")]],
    ...
    dict(
        ...
        expected_result=[
            pa.RecordBatch.from_arrays(
                [
                    pa.array(
                        [[b"34"], [str(-(sys.maxsize + 2)).encode("utf-8")]],
                        pa.large_list(pa.large_binary()),
                    ),
                ],
                ["feature"],
        ...
        expected_result=[
            pa.RecordBatch.from_arrays(
                [
                    pa.array(
                        [
                            [str(sys.maxsize + 1).encode("utf-8")],
    ...
    dict(
        testcase_name="empty_csv", input_lines=[], column_names=[], expected_result=[]
    ),
    dict(
        ...
        expected_result=[
            pa.RecordBatch.from_arrays(
                [pa.array([[12, 14]], pa.large_list(pa.int64()))], ["int_feature"]
            )
        ],
    ),
    dict(
        ...
        feature { name: "test_feature" type: BYTES }""",
            schema_pb2.Schema(),
        ),
    ...
    dict(
        ...
        expected_result=[
            pa.RecordBatch.from_arrays(
                [
                    pa.array(
                        [[b"", b""], [b"a", b"b"]], pa.large_list(pa.large_binary())
                    ),
