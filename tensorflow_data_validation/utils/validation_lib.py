...
from tensorflow_data_validation.api import stats_api, validation_api
from tensorflow_data_validation.coders import csv_decoder
from tensorflow_data_validation.statistics import stats_impl
from tensorflow_data_validation.statistics import stats_options as options
from tensorflow_data_validation.utils import io_util, stats_gen_lib, stats_util


def _encode_example_and_key(coder: example_coder.RecordBatchToExamplesEncoder, kv):
...
@beam.typehints.with_input_types(
    beam.typehints.KV[types.SliceKey, List[pa.RecordBatch]]
)
@beam.typehints.with_output_types(beam.typehints.KV[types.SliceKey, List[bytes]])
def _record_batch_to_example_fn(
    pcoll: beam.pvalue.PCollection, coder: example_coder.RecordBatchToExamplesEncoder
):
