...
from tensorflow_data_validation.utils import test_util, top_k_uniques_stats_util
...
class TopKUniquesStatsUtilTest(absltest.TestCase):
    def test_make_feature_stats_proto_topk_uniques(self):
        ...
        weighted_value_counts = [("e", 20), ("d", 20), ("a", 15), ("c", 10), ("b", 5)]
        top_k_value_count_list = [
            top_k_uniques_stats_util.FeatureValueCount(value_count[0], value_count[1])
        ...
        result = top_k_uniques_stats_util.make_feature_stats_proto_topk_uniques(
    ...
    def test_make_feature_stats_proto_topk_uniques_custom_stats(self):
        ...
        result = (
            top_k_uniques_stats_util.make_feature_stats_proto_topk_uniques_custom_stats(
                types.FeaturePath(["fa"]),
                num_top_values=3,
                frequency_threshold=1,
                weighted_frequency_threshold=1.0,
    ...
    def test_make_dataset_feature_stats_proto_topk_single(self):
        ...
        result = top_k_uniques_stats_util.make_dataset_feature_stats_proto_topk_single(
