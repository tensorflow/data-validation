...
from tensorflow_data_validation.utils import artifacts_io_impl, stats_util
...
class StatsUtilTest(absltest.TestCase):
    ...
    def test_make_dataset_feature_stats_proto(self):
        ...
        expected = {
            types.FeaturePath(["feature_1"]): text_format.Parse(
                """
            path {
              step: 'feature_1'
            }
           ...
           """,
            ...
            types.FeaturePath(["feature_2"]): text_format.Parse(
                """
            path {
              step: 'feature_2'
            }
    ...
    def test_get_utf8(self):
        self.assertEqual("This is valid.", stats_util.maybe_get_utf8(b"This is valid."))
    ...
    """,
        ...
        self.assertEqual(stats, stats_util.load_stats_tfrecord(input_path=stats_path))
        self.assertEqual(stats, stats_util.load_statistics(input_path=stats_path))
...
class DatasetListViewTest(absltest.TestCase):
    ...
    def test_list_slices(self):
        ...
        self.assertCountEqual(["slice0", "slice1", "All Examples"], view.list_slices())
    ...
    def test_get_feature_by_name(self):
        ...
        self.assertEqual(self._stats_proto.datasets[2].features[1], feature1.proto())

    def test_get_feature_by_path(self):
        view = stats_util.DatasetListView(self._stats_proto).get_default_slice()
        feature1 = view.get_feature(types.FeaturePath(["f0_step1", "f0_step2"]))
        self.assertEqual(self._stats_proto.datasets[2].features[0], feature1.proto())
    ...
    def test_get_derived_feature(self):
        view = stats_util.DatasetListView(self._stats_proto).get_default_slice()
        feature1 = view.get_derived_feature(
            "my_deriver_name",
            [types.FeaturePath(["f0_step1", "f0_step2"]), types.FeaturePath(["f1"])],
        )
        self.assertEqual(self._stats_proto.datasets[2].features[2], feature1.proto())
    ...
    def test_get_derived_feature_ambiguous(self):
        ...
        with self.assertRaisesRegex(ValueError, "Ambiguous result, 2 features matched"):
            view.get_derived_feature(
                "my_deriver_name",
                [
    ...
    def test_get_cross_feature(self):
        ...
        self.assertEqual(
            self._stats_proto.datasets[2].cross_features[0], cross_feature.proto()
        )
    ...
    """,
        ...
        with self.assertRaisesRegex(
            ValueError,
            ("Features must be specified with " "either path or name within a Dataset"),
        ):
...
class FeatureViewTest(absltest.TestCase):
    ...
    """,
        ...
        self.assertEqual(view.common_statistics(), feature.string_stats.common_stats)
    ...
    """,
        ...
        self.assertEqual(view.common_statistics(), feature.struct_stats.common_stats)
