...
def _assert_buckets_almost_equal(
...
class QuantilesUtilTest(absltest.TestCase):
    def test_generate_quantiles_histogram(self):
        result = quantiles_util.generate_quantiles_histogram(
            quantiles=np.array(
                [1.0, 60.0, 120.0, 180.0, 240.0, 300.0], dtype=np.float32
            ),
    ...
    def test_generate_quantiles_histogram_duplicate_buckets(self):
        result = quantiles_util.generate_quantiles_histogram(
            quantiles=np.array([1.0, 2.0, 2.0, 2.0, 3.0, 3.0, 4.0], dtype=np.float32),
...
_EQUI_WIDTH_BUCKETS_TESTS = [
    ...
    {
        "testcase_name": "finite_values_fractional_boundaries",
        "quantiles": [1, 2, 3, 4, 5, 7],
        "cumulative_counts": [2, 5, 7, 10, 12, 15],
        "finite_min": 1,
        "finite_max": 7,
    ...
    {
        "testcase_name": "leading_negative_inf",
    ...
    {
        "testcase_name": "trailing_inf",
        "quantiles": [1, 2, 3, float("inf"), float("inf")],
    ...
    {
        "testcase_name": "single_finite_between_inf",
    ...
    {
        "testcase_name": "leading_and_trailing_inf",
        "quantiles": [float("-inf"), 1, 2, 3, float("inf")],
        "cumulative_counts": [3, 5, 6, 7, 8],
        "finite_min": 1,
        "finite_max": 4,
        "num_buckets": 2,
    ...
    },
    {
        ...
        "num_pos_inf": 0.5,
        "expected_buckets": [
            _bucket(float("-inf"), float("inf"), 5),
        ],
    },
    {
        "testcase_name": "float32_overflow",
        "quantiles": [-3.4e38, 1, 3.4e38],
        ...
        "num_pos_inf": 0,
        "expected_buckets": [
            _bucket(-3.4e38, -1.1333333333333332e38, 2),
            _bucket(-1.1333333333333332e38, 1.1333333333333336e38, 1.666666666666667),
            _bucket(1.1333333333333336e38, 3.4e38, 1.3333333333333333),
        ],
    },
    {
        "testcase_name": "float64_overflow",
        "quantiles": [-1.7976931348623157e308, 0, 1.7976931348623157e308],
        "cumulative_counts": [1, 3, 5],
        "finite_min": -1.7976931348623157e308,
