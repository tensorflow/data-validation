...
_INVALID_INPUT_TEST_CASES = [
    ...
    dict(
        ...
        test_input=[{
            b"a": np.array([1, 2, 3], dtype=np.int32)
        }],
        expected_error=RuntimeError,
        expected_error_regexp="Unsupported ndarray type"),
    dict(
        ...
        expected_error=RuntimeError,
        expected_error_regexp="Expected ndarray type .* but got .*"),
    dict(
        ...
        expected_error=RuntimeError,
        expected_error_regexp="Expected bytes"),
]
